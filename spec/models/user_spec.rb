...
describe User do
  ...
  it "should accept valid email addresses" do
    addresses = %w[user@foo.com THE_USRE@foo.bar.org first.last@foo.jp]
  ...
  describe "password validation" do
    ...
    it "should require a matching password confirmations" do
  ...
  describe "password encryption" do
    ...
    describe "authenticate method" do
      ...
      it "should return the user on email on email/password match" do
